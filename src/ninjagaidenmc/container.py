...
class AbstractChunk(ABC):
    ...
    # mview must return memoryview object.
    @property
    @abstractmethod
    def mview(self):
        pass
...
class AbstractContainer(AbstractChunk, MutableSequence):
    ...
    @magic.setter
    def magic(self, val):
        self.mview[0:8] = val.ljust(0x8, b'\x00')
    ...
    def info_size(self, val):
        self.mview[0xc:0x10].cast('I')[0] = val
    ...
    def container_size(self, val):
        self.mview[0x10:0x14].cast('I')[0] = val
    ...
    def chunk_count(self, val):
        self.mview[0x14:0x18].cast('I')[0] = val
    ...
    def valid_chunk_count(self, val):
        self.mview[0x18:0x1c].cast('I')[0] = val
    ...
    def chunk_ofs_table_ofs(self, val):
        self.mview[0x20:0x24].cast('I')[0] = val
    ...
    def chunk_size_table_ofs(self, val):
        self.mview[0x24:0x28].cast('I')[0] = val
    ...
    def optional_chunk_ofs(self, val):
        self.mview[0x28:0x2c].cast('I')[0] = val
